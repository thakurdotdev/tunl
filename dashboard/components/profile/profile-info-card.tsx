      ...
      <form onSubmit={handleSubmit} className="mt-5 space-y-4">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            <Input
              ...
              value={profile?.email ?? ""}
              disabled
              className="bg-muted/40 text-muted-foreground mt-1 font-mono text-xs"
            />
          </div>
        </div>
        ...
        <div className="grid gap-4 pt-2 sm:grid-cols-3">
          <div className="bg-muted/30 border-border/60 rounded-lg border p-3">
            <span className="text-muted-foreground block text-[10px] uppercase">Account Role</span>
            <span className="text-foreground mt-0.5 inline-flex items-center gap-1 font-bold">
          ...
          <div className="bg-muted/30 border-border/60 rounded-lg border p-3">
            <span className="text-muted-foreground block text-[10px] uppercase">Active Plan</span>
            <span className="text-primary mt-0.5 block font-bold">
              {profile?.planName.toUpperCase()}
            </span>
          </div>

          <div className="bg-muted/30 border-border/60 rounded-lg border p-3">
            <span className="text-muted-foreground block text-[10px] uppercase">Member Since</span>
            <span className="text-foreground mt-0.5 inline-flex items-center gap-1 text-xs">
